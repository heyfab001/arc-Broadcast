...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-8 animate-fade-in max-w-5xl">
      {/* Page Heading */}
      <div className="pb-5 border-b border-gray-200 space-y-1.5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        ...
        <Link href="/broadcast" className="block group" prefetch>
          <GlassCard variant="interactive" className="p-6 sm:p-7 space-y-5 h-full flex flex-col justify-between">
            ...
            <div className="pt-3 flex items-center gap-2 text-base font-semibold text-blue-600 group-hover:text-blue-700">
